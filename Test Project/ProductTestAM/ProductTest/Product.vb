...
#Region " Methods "
    ...
    '*********************************************************************
    Public Shared Function GetProducts(ByVal sName As String, ByVal iCategoryID As Int32, ByVal bSold As Boolean, ByVal sColor As String) As ProductCollection
        Dim oCollection As New ProductCollection
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationManager.AppSettings("ConnectionString"), "PT_S_PT_DATA_Products",
                                                        0, sName, iCategoryID, bSold, sColor)
    ...
    '*********************************************************************
    Public Shared Function GetProductsDT(ByVal sName As String, ByVal iCategoryID As Int32, ByVal bSold As Boolean, ByVal sColor As String) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationManager.AppSettings("ConnectionString"), "PT_S_PT_DATA_Products",
                                                        0, sName, iCategoryID, bSold, sColor)
    ...
    Private Shared Function Load(ByRef oItem As Product, ByRef dr As DataRow) As Boolean
        ...
        oItem.Sold = Convert.ToBoolean(dr("Sold"))
        oItem.Color = dr("Color").ToString()
    ...
    Public Function Load() As Boolean
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationManager.AppSettings("ConnectionString"), "PT_S_PT_DATA_Products",
                                    _ID, String.Empty, 0, _Sold, _Color)
    ...
    Private Function Insert() As Boolean
        _ID = Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationManager.AppSettings("ConnectionString"), "PT_N_PT_DATA_Products",
                                _Name, _CategoryID, _Price, _Sold, _Color))
    ...
    Private Function Update() As Boolean
        SqlHelper.ExecuteNonQuery(ConfigurationManager.AppSettings("ConnectionString"), "PT_U_PT_DATA_Products",
                                _ID, _Name, _CategoryID, _Price, _Sold, _Color)
...
Public Class ProductCollection
    ...
    Default Public Shadows Property Item(index As Integer) As Product
        Get
