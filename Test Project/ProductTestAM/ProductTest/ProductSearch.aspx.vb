...
#End Region
    ...
    Private Sub BindData()
        Dim oProducts As ProductCollection = Product.GetProducts(txtName.Text, Convert.ToInt32(cboCategory.SelectedValue), ckSold.Checked, txtColor.Text)
    ...
    Private Sub btnCreatePDF_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreatePDF.Click
        ...
        Dim sUrl As String = String.Format("ProductReport.aspx?Name={0}&CategoryID={1}&Color={2}&Sold={3}", HttpUtility.UrlEncode(txtName.Text), Convert.ToInt32(cboCategory.SelectedValue), HttpUtility.UrlEncode(txtColor.Text), ckSold.Checked)
